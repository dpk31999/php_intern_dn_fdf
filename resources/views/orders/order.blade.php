            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="heading-title text-center">
                        <h2>@lang('homepage.total-order-in-website')</h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active">
                            <table class="table table-image">
                                <thead>
                                    <tr>
                                        <th scope="col">@lang('homepage.order-id')</th>
                                        <th scope="col">@lang('homepage.order-date')</th>
                                        <th scope="col">@lang('products.price')</th>
                                        <th scope="col">@lang('homepage.order-status')</th>
                                        <th scope="col"></th>
                                    </tr>
                                </thead>
                                <tbody id="list_order">
