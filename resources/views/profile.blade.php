                            ...
                            <div class="form-group">
                                <div class="col-xs-6">
                                    <label for="old-password">
                                        <h4>@lang('users.old_pass')</h4>
                                    </label>
                                    <input type="password" id="oldpasswordInput" class="form-control"
                                        name="oldpassword" placeholder="@lang('users.old_pass')">
                            ...
                            <div class="form-group">
                                <div class="col-xs-6">
                                    <label for="password-confirmation">
                                        <h4>@lang('auth.password_confirm')</h4>
                                    </label>
                                    <input id="password_confirmation" type="password" class="form-control"
                                        name="password_confirmation" placeholder="@lang('auth.password_confirm')">
