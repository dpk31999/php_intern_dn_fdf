            ...
            <div class="col-sm-4">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item text-right d-flex justify-content-between"><span
                            class="pull-left"><strong>@lang('users.num-order')</strong></span>{{ $user->orders->count() }}
                    </li>
                    <li class="list-group-item text-right d-flex justify-content-between"><span
                            class="pull-left"><strong>@lang('users.num-suggest')</strong></span>{{ $user->suggestProducts->count() }}
                    </li>
                    <li class="list-group-item text-right d-flex justify-content-between"><span
                            class="pull-left"><strong>@lang('users.num-favorite')</strong></span>{{ $user->favoriteProducts->count() }}
                    </li>
                </ul>
            </div>
            <div class="col-sm-7">
                    ...
                    <div class="tab-pane active" id="home">
                        <form class="form" action="{{ route('profile.info') }}" method="POST">
                            ...
                            <div class="form-group">
                                <div class="col-xs-6">
                                    <label for="phone">
                                        <h4>@lang('users.phone-number')</h4>
                                    </label>
                                    <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                        value="{{ $user->phone == '' ? '' : $user->phone }}" name="phone"
                                        placeholder="@lang('users.phone-number')">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <button class="btn btn-lg btn-success" type="submit"><i
                                            class="glyphicon glyphicon-ok-sign"></i> @lang('products.update')</button>
                                </div>
                            </div>
                        </form>
