    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalRegister">Infomation suggest</h5>
            ...
            <div class="modal-body">
                <form method="POST" id="suggestForm">
                    ...
                    <div class="form-group row">
                        <label for="cateInputSuggest" class="col-md-4 col-form-label text-md-right">@lang('suggest.cate-id')</label>
                    ...
                    <div class="form-group row">
                        <label for="nameInputSuggest"
                            class="col-md-4 col-form-label text-md-right">@lang('products.name-product')</label>
