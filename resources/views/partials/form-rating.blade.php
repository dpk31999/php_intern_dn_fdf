<div class="row mb-5">
    <form id="form_add_rating" data-id="{{ $product->id }}" class="m-auto w-50">
        <div class="feedback">
            <div class="rating">
        ...
        <span class="invalid-feedback" role="alert" id="ratingErrorRating">
            <strong></strong>
        </span>
        <div class="form-group">
            <label for="content">@lang('homepage.content') </label>
            <textarea class="form-control" rows="5" id="contentInputRating" name="content" required autocomplete="content">
            </textarea>

            <span class="invalid-feedback" role="alert" id="contentErrorRating">
                <strong></strong>
            </span>
        </div>
        <div class="form-group d-flex justify-content-center">
            <button class="btn btn-primary">@lang('products.add')</button>
        </div>
    </form>
</div>
