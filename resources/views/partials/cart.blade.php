            ...
            <div class="modal-body">
                <table class="table table-image">
                    <thead>
                        <tr>
                            <th scope="col"></th>
                            <th scope="col">@lang('products.name_product')</th>
                            <th scope="col">@lang('products.price')</th>
                            <th></th>
                            <th scope="col">@lang('homepage.quantity')</th>
                            <th></th>
                            <th scope="col">@lang('homepage.total')</th>
                            <th scope="col">@lang('homepage.action')</th>
                        </tr>
                    </thead>
                    <tbody id="list_items">
                        @if (session()->has('cart'))
                ...
                <div class="d-flex justify-content-end">
                    <h5>@lang('homepage.total') <span class="price text-success" id="total_price">{{ session()->get('cart')->totalPrice ?? '0' }}</span></h5>
                </div>
            </div>
