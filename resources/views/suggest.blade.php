...
@section('content')
    ...
    <div class="all-page-title page-breadcrumb">
        <div class="container text-center">
            <div class="row">
                <div class="col-lg-12">
                    <h1>@lang('homepage.suggest_title')</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4 contact-info ftco-animate">
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <h2 class="h4">@lang('homepage.contact_info')</h2>
                    </div>
                    <div class="col-md-12 mb-3">
                        <p><span>@lang('users.address')</span> Sun* Inc</sp>
                    </div>
                    <div class="col-md-12 mb-3">
                        <p><span>@lang('users.phone_number')</span> <a href="tel://0826792146">+ 0826792146</a></p>
                    </div>
                    <div class="col-md-12 mb-3">
                        <p><span>@lang('homepage.email_address')</span> <a href="mailto:hvd.03.12.99@gmail.com">hvd.03.12.99@gmail.com</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 ftco-animate">
                <form method="POST" id="form_suggest" class="contact-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input name="email" id="emailInputSuggest" value="{{ $user->email }}" type="text" class="form-control" placeholder="@lang('homepage.email_address')">
                            </div>
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <select id="cateInputSuggest" class="form-control">
                                <option value="">@lang('categories.chose_parent')</option>
                    ...
                    <div id="cate-hidden" class="form-group d-none">
                        <div class="form-group">
                            <label for="cate">@lang('homepage.child_cate') </label>
                            <select name="cate" id="cate_child" class="form-control">
                                <option value="">@lang('homepage.chose_child_cate')</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-group">
                            <input id="productInputSuggest" name="product" type="text" class="form-control" placeholder="@lang('products.name_product')">
                        </div>
                    ...
                    <div class="form-group">
                        <button type="submit" id="submit" class="btn btn-primary py-3 px-5">@lang('homepage.send_suggest')</button>
                    </div>
                </form>
            </div>
        </div>
